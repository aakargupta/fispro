...
import net.pocketmagic.android.eventinjector.MainActivity;
...
public class InjectActivity extends Activity implements OnClickListener, OnItemSelectedListener {
	...
	private void PopulateListView() {
		m_lvDevices.post(new Runnable() {
			public void run() {
				...
				CustomAdapter m_lvAdapter =  new CustomAdapter(InjectActivity.this, m_Devices);
			...
			public void run() {
				...
				// populate spinner
		     	ArrayAdapter<String>adapter = new ArrayAdapter<String>(
			       		InjectActivity.this, android.R.layout.simple_spinner_item,
			       		openDevs); 
